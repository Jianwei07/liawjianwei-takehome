...
Three mechanisms, all stdlib — no ML dependencies required:
...
Thresholds chosen to be permissive enough for natural-language paraphrases
while still catching clearly wrong answers.
"""
...
def score(test_id: str, response: str, expected: str) -> Score:
    ...
    if em >= THRESHOLDS["exact_match"]:
        ...
        passed = False
        reason = f"all below threshold — exact={em:.2f}, kf1={kf1:.2f}, seq={ss:.2f}"
